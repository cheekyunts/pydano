...
parser.add_argument(
    "--policy_id", help="Policy Id to get top holders for", type=str, default=None
)
parser.add_argument("--api_key", help="Blockfrost API Key", type=str)
parser.add_argument("--total_pages", help="Total Pages to request", type=int)
parser.add_argument(
...
parser.add_argument(
    "--exclude_address",
    help="Exclude Addresses",
    type=str,
    default="exclude_address.json",
)
parser.add_argument(
    "--sample_airdrop",
...
top_holders = TopHolders(
    args.policy_id, args.api_key, args.total_pages, args.use_cache, args.mainnet
)
